...
# Permite importar "app.*" cuando Alembic se ejecuta desde la raíz del
# proyecto backend/.
...
# La URL de conexión se resuelve en runtime desde las variables de entorno
# (.env), nunca hardcodeada en alembic.ini.
